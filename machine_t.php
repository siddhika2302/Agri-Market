...
if (!$conn) {
  die("Connection failed: " . mysqli_connect_error());
	...
	$machine_ID = mysqli_real_escape_string($conn, $_REQUEST['Machine_ID']);
	$Customer_ID = mysqli_real_escape_string($conn, $_REQUEST['Customer_ID']);
	
	$sql = "INSERT INTO machinery_transaction (trans_IDm,machine_ID,customer_ID) VALUES ('$trans_ID', '$machine_ID', '$Customer_ID')";
