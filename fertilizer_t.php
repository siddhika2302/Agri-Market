...
<body>
	...
	<h3>Welcome to your Fertilizer transaction page..!<?php echo $_POST["Customer_ID"]; ?></h3><br>
	<p>The ID of the product that you are buying is given below please verify:</p>
	<?php echo $_POST["Fertilizer_ID"]; ?><br>
	<?php 
...
if (!$conn) {
  die("Connection failed: " . mysqli_connect_error());
	...
	$trans_ID = mysqli_real_escape_string($conn, $_REQUEST['Transaction_ID']);
	$machine_ID = mysqli_real_escape_string($conn, $_REQUEST['Fertilizer_ID']);
	$Customer_ID = mysqli_real_escape_string($conn, $_REQUEST['Customer_ID']);
	
	$sql = "INSERT INTO fertilizer_transaction (trans_IDf,Fertilizer_ID,customer_ID) VALUES ('$trans_ID', '$machine_ID', '$Customer_ID')";
...
?>
	...
	<h3> Please proceed to the payment gateway </h3>
