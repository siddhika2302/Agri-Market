...
<html lang="en">
	...
	?>
		...
		<!-- One -->
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>Agri-Market</h2>
						<p>Explore the new way of trading the Crops... E-Farming made easy!!</p>
					</header>
					<div class="row 200%">
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Agri-Market &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agri-Market Office and Farms</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">243456789</p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Agri-Market</b></span>
				Agri-Market is e-commerce trading platform for grains & grocerries...
			</p>
...
<section>
						<h3>SignUp</h3>
							<form method="post" action="Login/signUp.php">
								...
								<div class="row uniform">
									<div class="6u 12u$(xsmall)">
										<input type="text" name="City" id="address" value="" placeholder="City" style="width:80%" required/>
									</div>
								</div>
